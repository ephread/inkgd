...
func test_blanks_in_inline_sequences():
	...
	assert_eq(story.continue_story_maximally(), "1. a\n2.\n3. b\n4. b\n---\n1.\n2. a\n3. a\n---\n1. a\n2.\n3.\n---\n1.\n2.\n3.\n")

func test_empty_sequence_content():
	var story := InkStory.new(load_file("empty_sequence_content"))

	assert_eq(story.continue_story_maximally(), "Wait for it....\nSurprise!\nDone.\n")
...
func test_all_sequence_types():
	...
	assert_eq(story.continue_story_maximally(), expected_story)
