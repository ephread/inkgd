...
func test_default_choice():
	...
	story.choose_choice_index(0)
	assert_eq(story.continue_story_maximally(), "After choice\nThis is default.\n")
...
func test_logic_in_choices():
	...
	story.choose_choice_index(0)
	assert_eq(story.continue_story_maximally(), "'Hello Joe,' I said, knowing full well that his name was Joe.\n")
...
func test_should_not_gather_due_to_choice():
	...
	assert_eq(story.continue_story_maximally(), "opt\ntext\n")
