...
func test_multi_thread():
	...
	assert_eq(story.continue_story_maximally(), "This is place 1.\nThis is place 2.\n")
	story.choose_choice_index(0)
	assert_eq(story.continue_story_maximally(), "choice in place 1\nThe end\n")
...
func test_thread_done():
	...
	assert_eq(story.continue_story_maximally(), "This is a thread example\nHello.\nThe example is now complete.\n")
