...
func test_arithmetic():
	...
	assert_eq(story.continue_story_maximally(), "36\n2\n3\n2\n2.33333333333333\n8\n8\n")

func test_basic_string_literals():
	var story := InkStory.new(load_file("basic_string_literals"))
	assert_eq(story.continue_story_maximally(), "Hello world 1\nHello world 2.\n")
...
func test_evaluation_stack_leaks():
	...
	assert_eq(story.continue_story_maximally(), "else\nelse\nhi\n")
...
func test_factorial_by_reference():
	...
	assert_eq(story.continue_story_maximally(), "120\n")
...
func test_increment():
	...
	assert_eq(story.continue_story_maximally(), "6\n5\n")
