...
func test_read_count_across_callstack():
	...
	assert_eq(story.continue_story_maximally(), "1) Seen first 1 times.\nIn second.\n2) Seen first 1 times.\n")
...
func test_turns_since_nested():
	...
	assert_eq(story.continue_story_maximally(), "more stuff\n1 = 1\n")
...
func test_turns_since():
	...
	story.choose_choice_index(0)
	assert_eq(story.continue_story_maximally(), "2\n")
...
func test_visit_count_bug_due_to_nested_containers():
	...
	story.choose_choice_index(0)
	assert_eq(story.continue_story_maximally(), "choice\n1\n")
