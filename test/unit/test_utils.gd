...
func test_valid_as_INamedContent():
	...
	assert_eq(InkUtils.as_INamedContent_or_null(name_content_like), name_content_like)

func test_invalid_as_INamedContent():
	var node = Node.new()

	assert_eq(InkUtils.as_INamedContent_or_null(node), null)
...
func test_trim_default():
	assert_eq(InkUtils.trim("       This is Ink    "), "This is Ink")
